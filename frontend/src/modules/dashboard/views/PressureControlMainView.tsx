    ...
    return (
        <Grid container className={classes.root}>
            <Grid container item xs={12} alignItems='stretch' className={classes.topPanel}>
                <Grid container item xs={3} direction='column' alignItems='stretch' className={classes.topLeftPanel}>
            ...
            <Grid container item xs={12} className={classes.bottomPanel}>
                <Grid container item xs={7} justify='center' alignItems='stretch' className={classes.bottomLeftPanel}>
                ...
                <Grid container item xs justify='center' alignItems='stretch' className={classes.bottomRightPanel}>
                    <Grid item xs className={classes.rightBorder}>
                        <TVInfo />
                    </Grid>
                    <Grid item xs >
